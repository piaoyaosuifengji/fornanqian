...
void main()
{
	...
	//quick_sort(data, left, right);
	 ...
	 double  usetime=(endtime-starttime)/1000;
	 printf("使用时间为%f秒\n排序后数据： \n",usetime);
	 //prinfdata(data, len);
	printf("end here \n");
}